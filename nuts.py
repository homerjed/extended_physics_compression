...
def nuts_sample(
    ...
    Float[Array, "#c #n p"] | Float[Array, "#n p"], 
    Float[Array, "#c #n"] | Float[Array, "#n"]
]:
    """
    ...
    return (
        states.position.transpose(1, 0, 2).squeeze(axis=0), 
        states.logdensity.transpose(1, 0).squeeze(axis=0)
    )